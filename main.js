...
function updateLocalStorage() {
  ...
  columns.forEach(function (column) {
    ...
    var columnTitle = column.querySelector("h2").textContent.trim();
    var cards = [];
    column.querySelectorAll(".card").forEach(function (card) {
      var cardId = card.dataset.cardId;
      var cardContent = card.querySelector("p").textContent.trim();
      cards.push({
        id: cardId,
        content: cardContent
      });
...
function restoreBoardFromLocalStorage() {
  var columnsContainer = document.querySelector(".board");
  var boardState = JSON.parse(localStorage.getItem("boardState"));
  //console.log(boardState);

  if (boardState) {
    columnsContainer.innerHTML = "";
    boardState.forEach(function (column) {
      var columnId = column.id;
      var columnTitle = column.title;
      var cards = column.cards;
      var columnTemplate = "\n          <div class=\"column\" data-column-id=\"".concat(columnId, "\">\n            <h2>").concat(columnTitle, "</h2>\n  \n            <ul class=\"column-cards\">\n              ").concat(cards.map(function (card) {
        return "\n                <li class=\"card\" draggable=\"true\" data-card-id=\"".concat(card.id, "\">\n                <button type=\"button\" class=\"delete-card-button\">&#x2715;</button>\n                  <p class=\"card-text\">").concat(card.content, "</p>\n                </li>");
...
function insertAboveTask(zone, mouseY) {
  var notActualElements = zone.querySelectorAll(".card:not(.is-dragging)");
  //console.log(notActualElements);

  var closestCard = null;
  var closestOffset = Number.NEGATIVE_INFINITY;
  notActualElements.forEach(function (elem) {
...
columnsContainer.addEventListener("click", function (e) {
  ...
  var column = clickTarget.closest(".column");
  var addCardLink = column.querySelector(".add-card-link");
  var columnCardsList = column.querySelector(".column-cards");
  var addCardSection = column.querySelector(".add-card-section");
  var textarea = column.querySelector(".textarea");
  var addCardButton = column.querySelector(".add-card-button");
  var cancelCardButton = column.querySelector(".cancel-card-button");
  if (clickTarget === addCardLink) {
    addCardSection.classList.remove("visually-hidden");
    addCardButton.addEventListener("click", function () {
      var cardContent = textarea.value.trim();
      if (cardContent) {
        var cardId = getRandomId();
        var cardTemplate = "\n            <div class=\"card\" draggable=\"true\" data-card-id=\"".concat(cardId, "\">\n            <button type=\"button\" class=\"delete-card-button\">&#x2715;</button>\n              <p class=\"card-text\">").concat(cardContent, "</p>\n            </div>\n          ");
  ...
  //!удаление карточки
  var deleteCardButtons = column.querySelectorAll(".delete-card-button");
...
columnsContainer.addEventListener("dragstart", function (e) {
  ...
  var droppables = document.querySelectorAll(".column-cards");
  ...
  droppables.forEach(function (zone) {
    zone.addEventListener("dragover", function (e) {
      //console.log(e);
      e.preventDefault();
      var bottomCard = insertAboveTask(zone, e.clientY);
      //console.log(bottomCard);
      var curCard = document.querySelector(".is-dragging");
      if (!bottomCard) {
...
columnsContainer.addEventListener("dragend", function () {
